...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_desc" class="form-label">Product Desciption</label>
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                <input type="file" id="product_image1" name="product_image1"
                    class="form-control border-dark w-90 m-auto" required>
                <img src="./product_images/<?php echo $product_image1 ?>" class="product_img" alt="Img">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                <input type="file" id="product_image2" name="product_image2"
                    class="form-control border-dark w-90 m-auto" required>
                <img src="./product_images/<?php echo $product_image2 ?>" class="product_img" alt="Img">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                <input type="file" id="product_image3" name="product_image3"
                    class="form-control border-dark w-90 m-auto" required>
                <img src="./product_images/<?php echo $product_image3 ?>" class="product_img" alt="Img">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
...
if (isset($_POST['edit_product'])) {
    ...
    // checking for fireld empty or not
    if($product_title=='' or $product_desc=='' or $product_keywords=='' or $product_category=='' or $product_brands=='' or $product_image1=='' or $product_image2=='' or $product_image3=='' or $product_price==''){
        echo "<script>alert('ALERT ! Please fill all the details and continue')</script>";

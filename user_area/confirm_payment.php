...
if(isset($_POST['confirm_payment'])){
    ...
    if($result){
        // echo "<script><h3 class='text-center text-light'>Payment Completed Successfully !</h3></script>";
        echo "<script>alert('Payment Completed Succesfully !')</script>";
    ...
    <div class="container my-5">
        ...
        <form action="" method="post">
            <div class="form-outline my-4 text-center w-50 m-auto">
                <label for="" class="text-light">Invoice no.</label>
            ...
            <div class="form-outline my-4 text-center w-50 m-auto">
                <input type="submit" class="bg-info btn px-3 py-2 border-0 text-dark" value="Confirm Payment"
                    name="confirm_payment" id="">
            </div>
